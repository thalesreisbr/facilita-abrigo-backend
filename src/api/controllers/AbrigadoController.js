...
const AbrigadoService = require('../services/AbrigadoService');
...
exports.findByPk = async (request, response, next) => {
	try {
		...
		const instancia = await AbrigadoService.findByPk(request.params.id)
...
exports.delete = async (request, response, next) => {
	try {
		...
		const result = await GenericServices.delete(request.params.id)
